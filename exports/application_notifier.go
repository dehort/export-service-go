...
// FIXME:  This could have been an interface too?  Which approach do we want to go with??
type NotifyApplicationOfExportJob func(ctx context.Context, identity string, payload models.ExportPayload) error

func KafkaBasedApplicationNotifier(kafkaChan chan *kafka.Message, log *zap.SugaredLogger) (NotifyApplicationOfExportJob, error) {
